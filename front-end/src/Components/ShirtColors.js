...
let filteredShirtsforcolor = stringType.filter((el)=>{
...
// }
  ...
  return <div className="colors">
    <div className="original-shirts"> {color === "Blue" && shirtType === "Tank" && <img
            className="shirtIcon"
...
{color === "White" && shirtType === "Button" && <img
            className="shirtIcon"
...
{color === "Black" &&  shirtType === "Sweat" &&<img
            className="shirtIcon"
      ...
      <ColorPick allColors={allColors} shirtType={shirtType} allTypes={allTypes} />
  </div>;
}
