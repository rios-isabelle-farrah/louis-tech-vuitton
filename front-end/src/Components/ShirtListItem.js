  ...
  return (
    ...
    <div className="shirt-details">
        <Link to={`/shirts/${shirt.id}`}>
          {shirt.color === "Blue" && shirt.type_of === "Tank" && <img
            className="shirtIcon"
...
{shirt.color === "White" && shirt.type_of === "Button-Up" && <img
            className="shirtIcon"
...
{shirt.color === "Black" &&  shirt.type_of === "Sweat-Shirt" &&<img
            className="shirtIcon"
...
{`Type: ${shirt.type_of}`}<br></br>
{`Color: ${shirt.color}`}<br></br>
